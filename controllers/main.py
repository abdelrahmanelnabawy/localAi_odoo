...
class LLMController(http.Controller):
    ...
    def chat(self, conversation_id, message,filename,file, **kwargs):
        """
        ...
        try:
            ...
            # Call LLM API
            response_content = self._call_llm_api(conversation.config_id, messages,ms.attachment)
    ...
    def _call_llm_api(self, config, messages,file=None):
        """
        Call the LLM API
        ...
        try:
            ...
            if(file):
                ...
                images = convert_from_bytes(pdf_bytes, first_page=1, last_page=1, dpi=72)[0]
                images.save(buffer, format="JPEG", quality=80)
                img_base64 = base64.b64encode(buffer.getvalue()).decode('utf-8')
                full_image_url = f"data:image/jpeg;base64,{img_base64}"
                
                last_message = data['messages'][::-1][0]
                ...
                data['messages'][::-1][0] =  last_message
